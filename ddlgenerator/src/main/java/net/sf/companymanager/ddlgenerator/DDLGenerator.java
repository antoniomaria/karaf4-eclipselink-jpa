 ...
 ******************************************************************************/
package net.sf.companymanager.ddlgenerator;
...
public class DDLGenerator {
    public void generate(final String databaseProviderName) throws IOException {
        ...
        persistProperties.put(PersistenceUnitProperties.DDL_GENERATION_MODE, "both");
        persistProperties.put(PersistenceUnitProperties.SESSION_CUSTOMIZER,
                "net.sf.companymanager.jpa.eclipselink.CamelNamingStrategy");
        ...
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("companymanager", persistProperties);
    ...
    private void addMysqlSettings(Map<String, String> persistProperties) {
        ...
        persistProperties.put(PersistenceUnitProperties.JDBC_URL, "jdbc:mysql://localhost:3306/companymanager_ref");
    ...
    public void addPostgresSettings(Map<String, String> persistProperties) {
        ...
        persistProperties.put(PersistenceUnitProperties.JDBC_URL, "jdbc:postgresql://localhost:5432/companymanager_ref");
